...
console.log(`${euros} Euros is equal to ${equivalentInAUD} Australian Dollars`)
...
console.log("Gary Oldman's cat's name (using array index):", cats_and_owners[1].cat)

let foundOwner = cats_and_owners.find(owner => owner.name === "Gary Oldman")
console.log("Gary Oldman's cat's name (using loop):", foundOwner.cat)
...
nobel_prize_winners_2017.prizes[0].laureates.forEach(physicsLaureates => {
  console.log("Physics Nobel laureate ID:", physicsLaureates.id)
})

let prizeCategories = nobel_prize_winners_2017.prizes.forEach(prize => prize.category)
